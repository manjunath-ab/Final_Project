...
import UI.Customer.GroceriesJPanel;
 ...
 * @author Admin
 */
public class PickLocationGrocery extends javax.swing.JPanel {

    /**
     * Creates new form PickLocationGrocery
     */
    String username;
    GroceryStall r;
    String name;
    ...
    public PickLocationGrocery(GroceryStall r, String username, String name, String location) {
        initComponents();
        this.r=r;
    ...
    private void init() {
        ...
        public void mouseClicked(MouseEvent e) {
            if(e.getClickCount() == 1 && e.getButton() == MouseEvent.BUTTON1){
                ...
                System.out.print(geo.getLatitude());
                GroceriesJPanel jpanel= new GroceriesJPanel(r,username,name,location,geo.getLatitude(),geo.getLongitude());
    ...
    private EventWaypoint getEvent() {
        return new EventWaypoint() {
            ...
            public void selected(MyWaypoint waypoint) {
                JOptionPane.showMessageDialog(PickLocationGrocery.this, waypoint.getName());
            }
        };
    }
